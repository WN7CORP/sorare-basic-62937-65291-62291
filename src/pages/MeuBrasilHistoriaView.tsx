  ...
  const carregarHistoria = async () => {
    try {
      ...
      const { data: cached, error: cacheError } = await supabase
        ...
        .select('*')
        .eq('periodo', periodoDecodificado)
        .single();
    ...
    return (
      <div className="px-3 py-4 max-w-4xl mx-auto pb-20">
        <Button
          variant="ghost"
          size="sm"
          onClick={() => navigate("/meu-brasil/historia")}
          className="mb-4"
        >
  ...
  return (
    <div className="px-3 py-4 max-w-4xl mx-auto pb-20">
      ...
      <JuristaArtigoCompleto
        ...
        categoria="História Jurídica"
        periodo={historia.ano_inicio && historia.ano_fim ? `${historia.ano_inicio} - ${historia.ano_fim}` : undefined}
        foto_url={historia.imagens?.[0]}
        conteudo_melhorado={historia.conteudo_melhorado}
        imagens={historia.imagens}
        links_relacionados={[]}
